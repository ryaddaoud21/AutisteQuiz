...
const quizdata=[
      {
        question:"Doesn't seem to understand simple questions or directions",
        options:["no", "Little", "Generally", "Yes"],
        answer:"Yes",
        category:1
      },
      {
        question:"Repeats literal words or phrases, but does not understand how to use them",
         options:["no", "Little", "Generally", "Yes"],
        answer:"Yes",
        category:2
      },
      {
        question:"He does not point out or bring things to share his interests",
        options:["no", "Little", "Generally", "Yes"],
        answer:"Yes",
        category:3
      },
      {
        question:"May be fascinated by details of an object, such as the wheels turning in a toy car, but not aware of the overall picture or function of the object" ,
        options:["no", "Little", "Generally", "Yes"],
        answer:"Yes",
        category:1
      },
      {
        question:"Establishes certain procedures or rituals, and gets upset when they change",
        options:["no", "Little", "Generally", "Yes"],
        answer:"Yes",
        category:1
      },
      {
        question:"Don't play imitation or pretend play",
        options:["no", "Little", "Generally", "Yes"],
        answer:"Yes",
        category:3
      },
      ...
      {
        question:"What are the pre-requisites (basic skills) for preferred communication?",
         options:["TV", "GAME", "Mimics "],
        answer:"GAME",
        category:3
      },
      {
        question:"what is the gender of your child",
        options:["man", "woman"],
        answer:"woman",
        category:1
      },
    ...
    function _animateCircle() {
      //2*pi*r == 753.6 +xxx=764
        ...
        if (_percentage >= _input_percentage) {
            ...
            console.log(unchnagedPer);

            if (unchnagedPer >= 60) {
                 _text_percentage.html('<tspan  x="50%" dy="1.9em">Your child level is : 1</tspan>');
            } else if  ((unchnagedPer >= 30) &&  (unchnagedPer < 60 )) {
                         _text_percentage.html('<tspan  x="50%" dy="1.9em">Your child level is : 2 </tspan>');
            } else { _text_percentage.html('<tspan  x="50%" dy="1.9em">Your child level is: 1 </tspan>');
                 }
